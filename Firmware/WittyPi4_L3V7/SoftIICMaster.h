 ...
 * 
 * Names for class, methods and symbols are changed 
 * to avoid confliction with namespace of ATtinyCore.
 *
 ...
 * - changed i2c_init_ to return true iff both SDA and SCL are high
...
#ifndef _SOFTIICMASTER_H
#define _SOFTIICMASTER_H   1
...
bool __attribute__ ((noinline)) i2c_init_(void) __attribute__ ((used));

// Start transfer function: <addr> is the 8-bit I2C address (including the R/W
// bit).
// Return: true if the slave replies with an "acknowledge", false otherwise
bool __attribute__ ((noinline)) i2c_start_(uint8_t addr) __attribute__ ((used));

// Similar to start function, but wait for an ACK! Be careful, this can
// result in an infinite loop!
void  __attribute__ ((noinline)) i2c_start_wait_(uint8_t addr) __attribute__ ((used));
...
// stop condition.
// Return: true if the slave replies with an "acknowledge", false otherwise
bool __attribute__ ((noinline)) i2c_rep_start_(uint8_t addr) __attribute__ ((used));

// Issue a stop condition, freeing the bus.
void __attribute__ ((noinline)) i2c_stop_(void) asm("ass_i2c_stop_") __attribute__ ((used));

// Write one byte to the slave chip that had been addressed
// by the previous start call. <value> is the byte to be sent.
// Return: true if the slave replies with an "acknowledge", false otherwise
bool __attribute__ ((noinline)) i2c_write_(uint8_t value) asm("ass_i2c_write_") __attribute__ ((used));


// Read one byte. If <last> is true, we send a NAK after having received
// the byte in order to terminate the read sequence.
uint8_t __attribute__ ((noinline)) i2c_read_(bool last) __attribute__ ((used));
...
void __attribute__ ((noinline)) i2c_delay_half(void) asm("ass_i2c_delay_half_")  __attribute__ ((used));
void __attribute__ ((noinline)) i2c_wait_scl_high(void) asm("ass_i2c_wait_scl_high_")  __attribute__ ((used));
...
bool  i2c_start_(uint8_t addr)
{
  __asm__ __volatile__
    (
     ...
     " rcall    ass_i2c_wait_scl_high_   ;wait until SCL=H\n\t"
...
bool  i2c_rep_start_(uint8_t addr)
{
  __asm__ __volatile__
...
void  i2c_start_wait_(uint8_t addr)
{
 __asm__ __volatile__
   (
    ...
    " sbi   %[SDADDR],%[SDAPIN] ;force SDA low \n\t"
    " rcall   ass_i2c_delay_half_  ;delay T/2 \n\t"
    " rcall   ass_i2c_write_         ;write address \n\t"
    " tst r24           ;if device not busy -> done \n\t"
    " brne  _Li2c_start_wait_done_ \n\t"
    " rcall ass_i2c_stop_          ;terminate write & enable IRQ \n\t"
...
void  i2c_stop_(void)
{
  __asm__ __volatile__
    (
     " sbi      %[SCLDDR],%[SCLPIN]     ;force SCL low \n\t"
     " sbi      %[SDADDR],%[SDAPIN]     ;force SDA low \n\t"
     " rcall    ass_i2c_delay_half_      ;T/2 delay \n\t"
     " cbi      %[SCLDDR],%[SCLPIN]     ;release SCL \n\t"
     " rcall    ass_i2c_delay_half_      ;T/2 delay \n\t"
     " sbis     %[SCLIN],%[SCLPIN]      ;check for clock stretching slave\n\t"
     " rcall    ass_i2c_wait_scl_high_   ;wait until SCL=H\n\t"
...
bool i2c_write_(uint8_t value)
{
  __asm__ __volatile__
    (
     " sec                              ;set carry flag \n\t"
     " rol      r24                     ;shift in carry and shift out MSB \n\t"
     " rjmp _Li2c_write_first_ \n\t"
     "_Li2c_write_bit_:\n\t"
     " lsl      r24                     ;left shift into carry ;; 1C\n\t"
     "_Li2c_write_first_:\n\t"
     " breq     _Li2c_get_ack_           ;jump if TXreg is empty;; +1 = 2C \n\t"
     " sbi      %[SCLDDR],%[SCLPIN]     ;force SCL low         ;; +2 = 4C \n\t"
     " nop \n\t"
     " nop \n\t"
     " nop \n\t"
     " brcc     _Li2c_write_low_                                ;;+1/+2=5/6C\n\t"
     " nop                                                     ;; +1 = 7C \n\t"
     " cbi %[SDADDR],%[SDAPIN]          ;release SDA           ;; +2 = 9C \n\t"
     " rjmp      _Li2c_write_high_                              ;; +2 = 11C \n\t"
     "_Li2c_write_low_: \n\t"
     " sbi  %[SDADDR],%[SDAPIN] ;force SDA low         ;; +2 = 9C \n\t"
     " rjmp _Li2c_write_high_                               ;;+2 = 11C \n\t"
     "_Li2c_write_high_: \n\t"
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;;+X = 11C+X\n\t"
#endif
     ...
     " rcall    ass_i2c_wait_scl_high_ \n\t"
     " brpl     _Ldelay_scl_high_                              ;;+2 = 18C+X\n\t"
     "_Li2c_write_return_false_: \n\t"
     " clr      r24                     ; return false because of timeout \n\t"
     " rjmp     _Li2c_write_return_ \n\t"
     "_Ldelay_scl_high_: \n\t"
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;;+X= 18C+2X\n\t"
#endif
     " rjmp _Li2c_write_bit_ \n\t"
...
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2 ;; +X = 7C+X \n\t"
#endif
     " clr  r25                                            ;; 17C+2X \n\t"
     ...
     " rcall    ass_i2c_wait_scl_high_ \n\t"
     " brmi     _Li2c_write_return_false_                       ;; 13C + X \n\t "
     " sbis %[SDAIN],%[SDAPIN]      ;if SDA hi -> return 0 ;; 15C + X \n\t"
     " ldi  r24,1                   ;return true           ;; 16C + X \n\t"
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;; 16C + 2X \n\t"
#endif
     "_Li2c_write_return_: \n\t"
     " nop \n\t "
     " nop \n\t "
...
uint8_t i2c_read_(bool last)
{
  __asm__ __volatile__
    (
     ...
     " nop \n\t"
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;; 4C+X \n\t"
#endif
     " cbi  %[SCLDDR],%[SCLPIN] ;release SCL           ;; 6C + X \n\t"
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;; 6C + 2X \n\t"
#endif
     ...
     " rcall    ass_i2c_wait_scl_high_ \n\t"
     " brmi     _Li2c_read_return_       ;return if timeout     ;; 10C + 2X\n\t"
     " clc                ;clear carry flag      ;; 11C + 2X\n\t"
     " sbic %[SDAIN],%[SDAPIN]  ;if SDA is high        ;; 11C + 2X\n\t"
     " sec              ;set carry flag        ;; 12C + 2X\n\t"
     " rol  r23           ;store bit             ;; 13C + 2X\n\t"
     " brcc _Li2c_read_bit_          ;while receiv reg not full \n\t"
     "                         ;; 15C + 2X for one bit loop \n\t"

     "_Li2c_put_ack_: \n\t"
     " sbi  %[SCLDDR],%[SCLPIN] ;force SCL low         ;; 2C \n\t"
     " cpi  r24,0                                          ;; 3C \n\t"
     " breq _Li2c_put_ack_low_ ;if (ack=0) ;; 5C \n\t"
     " cbi  %[SDADDR],%[SDAPIN] ;release SDA \n\t"
     " rjmp _Li2c_put_ack_high_ \n\t"
     "_Li2c_put_ack_low_:                ;else \n\t"
     ...
     " nop \n\t "
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;; 7C + X \n\t"
#endif
     ...
     " rcall    ass_i2c_wait_scl_high_ \n\t"
#if I2C_DELAY_COUNTER >= 1
     " rcall  ass_i2c_delay_half_  ;delay T/2             ;; 11C + 2X\n\t"
#endif
     "_Li2c_read_return_: \n\t"
     " nop \n\t "
     " nop \n\t "
